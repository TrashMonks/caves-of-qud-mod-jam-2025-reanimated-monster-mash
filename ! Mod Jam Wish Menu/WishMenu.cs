...
namespace XRL.World.Parts
{
    ...
    public class Reanimated_MonsterMash_ModJam_Wish_Handler : IPlayerPart
    {
        public const string XML_ROOT = "reanimatedmonstermashwishcommands";

        public static string COMMAND_NAME = "CmdReanimatedMonsterMashWishMenu";
        ...
        [WishCommand("reanimatedmonstermashwishmenu")]
        public static void RunWishMenu()
        {
            CacheInit();
            var choice = Popup.PickOption(
                "reanimated Monster Mash-Up Wish Menu",
...
[PlayerMutator]
public class Reanimated_MonsterMash_ModJam_PlayerMutator : IPlayerMutator
{
    public void mutate(GameObject player)
    {
        player.RequirePart<XRL.World.Parts.Reanimated_MonsterMash_ModJam_Wish_Handler>();
    }
}
